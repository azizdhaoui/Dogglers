...
*/
package com.aziz.dogglers.adapter
...
import com.aziz.dogglers.R
import com.aziz.dogglers.const.Layout
import com.aziz.dogglers.data.DataSource
import com.aziz.dogglers.model.Dog
...
class DogCardAdapter(
    ...
    val dog_list : List<Dog> = DataSource.dogs
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        if (viewType == Layout.GRID){
            val gridAdaptor =adaptorLayout.inflate(R.layout.grid_list_item,parent,false)
            return DogCardViewHolder(gridAdaptor)
        }
        else{
            val hvad = adaptorLayout.inflate(R.layout.vertical_horizontal_list_item,parent,false)
            return DogCardViewHolder(hvad)
        }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        val dog = dog_list[position]
        holder.imageView.setImageResource(dog.imageResourceId)
        holder.textViewName.setText(dog.name)
